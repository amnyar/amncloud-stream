...
ApplicationWindow {
    ...
    function handleNeedsSignup(phoneNum) {
        ...
        stackView.push({
            ...
            onRegistrationSuccess: handleLoginSuccess // Reuse the same handler
        })
    }
    // --- End Navigation Handler Functions ---
    ...
    StackView {
        ...
        Component.onCompleted: {
             doEarlyInit()
             stackView.clear()
             // Push initial Login page and connect its signals
             stackView.push({
                 item: "qrc:/gui/LoginWithPhone.qml",
                 properties: { }, // Add any properties needed for LoginWithPhone
                 onLoginSuccess: handleLoginSuccess, // Connect to handler function
                 onNeedsSignup: handleNeedsSignup  // Connect to handler function
             })
        }
